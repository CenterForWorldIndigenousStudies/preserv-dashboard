...
import { BATCHES_PATH, DASHBOARD_PATH, READY_FOR_LIBRARY_PATH, REVIEW_QUEUE_PATH } from '@constants/paths'
...
const REPORT_WORKSPACE_LINKS: ReportWorkspaceLink[] = [
  {
    ...
    description:
      'Open the live operational snapshot for review backlog, library-ready work, and current batch activity.',
  },
  {
    href: BATCHES_PATH,
    title: PAGE_LABELS.batches,
    description:
      'Review the current batch processing details and batch-level activity already available in the dashboard.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Review documents that meet the current dashboard-visible library criteria without implying final handoff readiness.',
  },
]
...
export default function ReportsPage(): ReactElement {
  return (
    <Stack spacing={8}>
      <PageHeader
        eyebrow={PAGE_LABELS.reports}
        title={'Preservation Pipeline Reports'}
        description={
      ...
      <Stack component={'section'} spacing={2}>
        <Box>
          ...
          <Typography variant={'body2'} sx={{ color: 'text.secondary', mt: 1 }}>
            {
              'Use these existing routes to review operational signals. This page does not add new reporting logic or derived analytics.'
            }
          </Typography>
        </Box>
