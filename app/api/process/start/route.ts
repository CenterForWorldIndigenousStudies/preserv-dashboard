...
import {
  normalizeRequestedProcessStages,
...
export async function POST(request: NextRequest): Promise<NextResponse> {
  ...
  let body: ProcessStartRequestBody
  try {
    body = (await request.json()) as ProcessStartRequestBody
  } catch {
  ...
  const requestedStages = normalizeRequestedProcessStages(body.requestedStages)
