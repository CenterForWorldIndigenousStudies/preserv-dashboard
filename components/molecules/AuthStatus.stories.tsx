  ...
  render: () => (
    <div className="rounded-2xl border border-moss/15 bg-white p-6 shadow-panel">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="rounded-full bg-ink/10 px-4 py-2 text-sm text-ink hover:bg-ink/20">
          Sign Out
        </button>
      </div>
    </div>
...
export const SignedOut: Story = {
  ...
  render: () => (
    <div className="rounded-2xl border border-moss/15 bg-white p-6 shadow-panel">
      ...
      <button className="rounded-full bg-moss px-4 py-2 text-sm text-white hover:bg-moss/90">
        Sign In
      </button>
    </div>
  ),
