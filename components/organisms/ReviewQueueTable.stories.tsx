...
const sampleItems: ReviewQueueItem[] = [
  ...
  },
  {
    ...
    needs_review: true,
    sensitive: true,
    queue_reasons: ['Needs revision', 'Needs review metadata', 'Sensitive metadata'],
  },
  {
    id: UUIDS.doc3,
    ...
    needs_review: false,
    sensitive: true,
    queue_reasons: ['Sensitive metadata'],
  },
  {
    id: UUIDS.doc4,
    name: null,
    ...
    initialData: {
      items: [
        ...sampleItems,
        {
          ...
          needs_review: true,
          sensitive: false,
          queue_reasons: ['Needs revision', 'Needs review metadata'],
        },
      ],
      total: 5,
    },
