  ...
  const columns = useMemo<MRT_ColumnDef<ReviewQueueItem>[]>(() => [
    ...
    },
    {
      ...
      Cell: ({ renderedCellValue }) => {
        ...
        return val ? (
          <span style={{ borderRadius: "9999px", backgroundColor: "#9e3f2f", color: "white", padding: "2px 12px", fontSize: "0.75rem", fontWeight: 500 }}>
            Yes
          </span>
        ) : (
    ...
    },
    {
      ...
      Cell: ({ renderedCellValue }) => {
        const val = renderedCellValue as boolean;
        return val ? (
          <span style={{ borderRadius: "9999px", backgroundColor: "#231f20", color: "#f4f1f0", padding: "2px 12px", fontSize: "0.75rem", fontWeight: 500 }}>
            Yes
          </span>
        ) : (
          <span style={{ color: "rgba(35,31,32,0.5)" }}>No</span>
