      ...
      <CardContent sx={{ p: 2.5, '&:last-child': { pb: 2.5 } }}>
        <Stack spacing={1.5}>
          ...
          <Typography variant={'body2'} color={'text.secondary'}>
            {
              'This queues the downstream translation step for completed batches containing the documents currently eligible in this workspace. Runtime collection, duplicate, Drive, and Workbench checks still run during handoff.'
            }
          </Typography>
          <Button
            variant={'contained'}
