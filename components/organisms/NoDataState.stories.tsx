...
const meta: Meta<typeof NoDataState> = {
  ...
  args: {
    title: 'No Data',
    message: 'There are no documents in the queue at this time. Check back later or adjust your filters.',
  },
  parameters: {
    backgrounds: {
      default: 'sand',
...
export const NoDocumentsFound: Story = {
  args: {
    ...
    message: 'No documents matched your search criteria. Try adjusting your filters or search query.',
  },
}
...
export const NoFailures: Story = {
  args: {
    ...
    message: 'No pipeline failures detected. All documents are processing normally.',
  },
}
...
export const EmptyCollection: Story = {
  args: {
    ...
    message: 'This collection has no documents yet. Upload documents to get started with preservation.',
  },
}
